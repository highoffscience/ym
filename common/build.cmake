...
#
# @param Ctx_JSON -- The context (parameters) as a JSON string.
#        Keys used are:
#           ProjRootDir
#
function(ym.common Ctx_JSON)

   string(JSON PROJ_ROOT_DIR ERROR_VARIABLE ERROR_ON_GET GET ${Ctx_JSON} ProjRootDir)

   set(Target ${CMAKE_CURRENT_FUNCTION})
   set(SrcNames logger textlogger timer ymassert ymdefs ymutils)
   set(SrcFilesPath ${PROJ_ROOT_DIR}/ym/common/)
