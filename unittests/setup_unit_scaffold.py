...
def gen_header_file(args: argparse.Namespace):
 ...
 # else - continue...
   ...
   with open(hdr_file, "w") as outfile:
      ...
      writeln(f" *                                          ")
      writeln(f" * @note File used in unittests - " \
              f"maximum standard C++20 (cppyy restriction). ")
      writeln(f" */                                         ")
      writeln(f"                                            ")
      ...
      writeln(f"                                            ")
      writeln(f"   YM_UNIT_TESTCASE(InteractiveInspection)  ")
      writeln(f"   YM_UNIT_TESTCASE(SmokeTest)              ")
      writeln(f"}};                                         ")
      writeln(f"                                            ")
      writeln(f"}} // ym::unit                              ")
...
def gen_source_file(args: argparse.Namespace):
 ...
 # else - continue...
   ...
   with open(src_file, "w") as outfile:
      ...
      writeln(f"                                                                          ")
      writeln(f"#include \"{args.filename}.h\" // Structures under test                   ")
      writeln(f"                                                                          ")
      writeln(f"#include \"fmt/format.h\"                                                 ")
      writeln(f"                                                                          ")
      writeln(f"/**                                                                       ")
      ...
      writeln(f"   addTestCase<SmokeTest>();                                              ")
      writeln(f"}}                                                                        ")
      writeln(f"                                                                          ")
      writeln(f"/**                                                                       ")
...
def gen_runner_file(args: argparse.Namespace):
 ...
 # else - continue...
   ...
   with open(runner_file, "w") as outfile:
      ...
      # TODO version and author should be input params
      writeln(f"##                                                                      ")
      ...
      writeln(f"      \"\"\"                                                            ")
      writeln(f"      Set up logic that is run before each test.                        ")
      writeln(f"      \"\"\"                                                            ")
      writeln(f"      pass                                                              ")
      writeln(f"                                                                        ")
      writeln(f"   def tearDown(self):                                                  ")
      writeln(f"      \"\"\"                                                            ")
      writeln(f"      Tear down logic that is run after each test.                      ")
      writeln(f"      \"\"\"                                                            ")
      writeln(f"      pass                                                              ")
      writeln(f"                                                                        ")
      writeln(f"   def test_InteractiveInspection(self):                                ")
      writeln(f"      \"\"\"                                                            ")
      writeln(f"      Analyzes results from test case.                                  ")
      writeln(f"      \"\"\"                                                            ")
      ...
      writeln(f"      self.assertTrue(results.get[bool](\"True\"), \"Truth is naught\") ")
      writeln(f"                                                                        ")
      writeln(f"# kick-off                                                              ")
