...
def gen_src_file(args):
   ...
   if not os.path.exists(src_file):
      with open(src_file, "w") as outfile:
         ...
         writeln(f"except:")
         writeln(f"   print("Cannot import unittesbase - did you set the correct path?")")
         ...
         writeln(f"      super().__init__("ym/common/", "random", "Random", [])")
         writeln(f"")
         writeln(f"   """ run")
         writeln(f"   ")
         ...
         writeln(f"   if os.path.basename(os.getcwd()) != "random":")
         writeln(f"      print("Needs to be run in the random/ directory")")
         writeln(f"      sys.exit(1)")
         writeln(f"")
